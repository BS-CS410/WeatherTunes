    ...
    <div className="flex min-h-dvh flex-col overflow-auto">
      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col items-stretch gap-4 px-4">
        ...
        <header className="-mb-5 w-full py-6 text-left">
          <h1 className="text-5xl font-bold tracking-tight text-slate-100 drop-shadow-lg transition-transform duration-200 will-change-transform select-none hover:scale-[1.02] hover:drop-shadow-2xl">
            weathertunes
          </h1>
        </header>
