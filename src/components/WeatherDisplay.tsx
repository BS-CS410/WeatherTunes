...
export function WeatherDisplay({ weatherData }: WeatherDisplayProps) {
  ...
  return (
    <section className="flex w-full flex-col items-start">
      ...
      <div className="font-inter-tight w-full text-left text-[clamp(2.5rem,12vw,8rem)] leading-none font-bold text-gray-900 drop-shadow-lg transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:scale-105 hover:drop-shadow-md dark:text-cyan-50">
        {`${temperature}${unit}`}
      </div>
