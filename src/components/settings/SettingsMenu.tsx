...
import { GLASS_CARD_STYLES, TEXT_COLORS, LAYOUT } from "@/lib/sharedStyles";
...
export function SettingsMenu({ isOpen, onClose }: SettingsMenuProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <Card className={cn("mx-4 w-full max-w-md", GLASS_CARD_STYLES.modal)}>
        <CardContent className={LAYOUT.cardPadding}>
          <div className="mb-6 flex items-center justify-between">
            <h2 className={cn("text-2xl font-bold", TEXT_COLORS.primary)}>
              Settings
            </h2>
            <Button
              variant="outline"
