/**
 * Simplified Design System - Preserving Liquid Glass Visual Effects
...
export const LAYOUT = {
  ...
  spacing: {
    ...
    lg: "gap-6",
    xl: "gap-8",
    spaceY: { sm: "space-y-2", md: "space-y-4", lg: "space-y-6" },
    spaceX: { sm: "space-x-2", md: "space-x-4", lg: "space-x-6" },
    micro: "gap-[2px]",
  },
  padding: {
    none: "p-0",
    ...
    lg: "p-6",
    xl: "p-8",
    button: { sm: "px-4 py-2", md: "px-6 py-3", lg: "px-8 py-4" },
    section: { sm: "px-2 py-4", md: "px-4 pb-4 pl-2", lg: "p-8" },
  },
  rounded: {
    sm: "rounded-lg",
    base: "rounded-xl",
...
// Simplified component style builders with preserved visual effects
export const CARD_STYLES = {
  base: `${COLORS.glass.light} ${COLORS.glass.dark} ${LAYOUT.rounded.base} ${COLORS.shadow.liquidGlass} ${ANIMATIONS.transition.standard}`,
  interactive: `${COLORS.glass.interactive} ${LAYOUT.rounded.base} ${COLORS.shadow.liquidHover} ${ANIMATIONS.transition.liquid} group`,
  enhanced: `${COLORS.glass.enhanced} ${LAYOUT.rounded.lg} ${COLORS.shadow.liquidGlass} ${ANIMATIONS.transition.elastic} ${ANIMATIONS.liquidGlass.breathe} relative overflow-hidden`,
  chromatic: `${COLORS.glass.chromatic} ${LAYOUT.rounded.base} ${COLORS.shadow.liquidGlass} ${ANIMATIONS.transition.liquid} ${ANIMATIONS.liquidGlass.chromatic} relative overflow-hidden`,
  floating: `${COLORS.glass.floating} ${LAYOUT.rounded.lg} ${COLORS.shadow.liquidHover} ${ANIMATIONS.transition.spring} relative overflow-hidden`,
  segmented: `${COLORS.glass.segmented} ${LAYOUT.rounded.base} ${COLORS.shadow.liquidGlass} ${ANIMATIONS.transition.fast} p-2 relative overflow-hidden`,
  segmentedActive: `${COLORS.glass.segmentedActive} ${LAYOUT.rounded.base} ${COLORS.shadow.liquidHover} ${ANIMATIONS.transition.fast} ${ANIMATIONS.liquidGlass.elastic}`,
  morphing: `${COLORS.glass.enhanced} ${LAYOUT.rounded.base} ${COLORS.shadow.liquidGlass} ${ANIMATIONS.transition.elastic} ${ANIMATIONS.liquidGlass.morph} ${ANIMATIONS.liquidGlass.displacement} relative overflow-hidden transform-gpu`,
  modal: `${COLORS.glass.modal} ${LAYOUT.rounded.lg} ${COLORS.shadow.liquidHover} backdrop-blur-3xl backdrop-saturate-[2.5] border border-white/[0.25] dark:border-white/[0.15] relative overflow-hidden`,
  elastic: `${COLORS.glass.enhanced} ${LAYOUT.rounded.base} ${COLORS.shadow.liquidGlass} ${ANIMATIONS.transition.elastic} ${ANIMATIONS.liquidGlass.elastic} relative overflow-hidden transform-gpu cursor-pointer before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/[0.1] before:to-transparent before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-100`,
} as const;
